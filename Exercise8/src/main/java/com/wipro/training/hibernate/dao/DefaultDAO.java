...
public class DefaultDAO<T extends BaseEntity> {
	...
	public void mergeNoTransaction(final T entity) {
		//getTransaction().begin();
	...
	public String getState(final T entity) {
		if (entity == null || entity.getId() == null) {
			return "Transient";
		}

		return entityManager.contains(entity) && entityManager.find(this.entityClass, entity.getId()) != null ? "Managed" : "Detached";
	}
